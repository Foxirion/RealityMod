package net.foxirion.realitymod.entity.animations;
...
public class ModAnimationDefinitions {
    ...
    public static final AnimationDefinition DESERT_TURTLE_WALK = AnimationDefinition.Builder.withLength(2f).looping()
    ...
    public static final AnimationDefinition DESERT_TURTLE_IDLE = AnimationDefinition.Builder.withLength(2f).looping()
            .addAnimation("torso",
                    new AnimationChannel(AnimationChannel.Targets.POSITION,
                            new Keyframe(0f, KeyframeAnimations.posVec(0f, 0f, 0f),
                                    AnimationChannel.Interpolations.CATMULLROM),
    ...
    public static final AnimationDefinition FENNEC_IDLE = AnimationDefinition.Builder.withLength(2.0F).looping()
            .addAnimation("head", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F),
                            AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(1.0F, KeyframeAnimations.posVec(0.0F, -0.1F, 0.0F),
                            AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(2.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F),
                            AnimationChannel.Interpolations.CATMULLROM)
            ))
            .addAnimation("ear0", new AnimationChannel(AnimationChannel.Targets.ROTATION,
    ...
    public static final AnimationDefinition FENNEC_WALK = AnimationDefinition.Builder.withLength(0.5F).looping()
    ...
    public static final AnimationDefinition FENNEC_IDLE_STANDING = AnimationDefinition.Builder.withLength(2.0F).looping()
            .addAnimation("fennec", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, -2.4F, 0.0F),
                            AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(2.0F, KeyframeAnimations.posVec(0.0F, -2.4F, 0.0F),
                            AnimationChannel.Interpolations.LINEAR)
            ))
            .addAnimation("head", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F),
            ...
            .addAnimation("leg0", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(-90.0F, 0.0F, 0.0F),
                            AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(2.0F, KeyframeAnimations.degreeVec(-90.0F, 0.0F, 0.0F),
                            AnimationChannel.Interpolations.LINEAR)
            ))
            .addAnimation("leg0", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.0F, KeyframeAnimations.posVec(0.1F, 0.0F, 0.0F),
                            AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(2.0F, KeyframeAnimations.posVec(0.1F, 0.0F, 0.0F),
                            AnimationChannel.Interpolations.LINEAR)
            ))
            .addAnimation("leg1", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(-90.0F, 0.0F, 0.0F),
    ...
    public static final AnimationDefinition FENNEC_EARS_FLAPPING = AnimationDefinition.Builder.withLength(1.0F).looping()
            .addAnimation("ear0", new AnimationChannel(AnimationChannel.Targets.ROTATION,
